...
export default function BuyTimelineScreen() {
  ...
  const handleNext = () => {
    ...
    router.push({
      pathname: '/open-plots/buy-contact',
      ...
      <SafeAreaView className="flex-1" edges={['top']}>
        ...
        <View className="flex-row items-center px-4 py-3 border-b border-gray-100">
          ...
          <View className="flex-1 items-center">
            ...
            <Text className="text-gray-500 text-xs mt-0.5">Step 7 of 8</Text>
          </View>
          <View className="w-10" />
        </View>
        ...
        <View className="px-4 pt-3">
          <View className="h-1.5 bg-gray-200 rounded-full overflow-hidden">
            <View className="h-full w-[87.5%] bg-orange-500 rounded-full" />
          </View>
        </View>
        ...
        <View className="px-6 pb-8">
          <Pressable
            ...
            className={`rounded-2xl py-5 items-center ${
              selectedTimeline ? 'bg-orange-500' : 'bg-gray-300'
            }`}
            style={{
              shadowColor: selectedTimeline ? '#F97316' : '#000',
