...
export default function BuyPlotSizeScreen() {
  ...
  const handleNext = () => {
    ...
    router.push({
      pathname: '/open-plots/buy-budget',
      ...
      <SafeAreaView className="flex-1" edges={['top']}>
        ...
        <View className="flex-row items-center px-4 py-3 border-b border-gray-100">
          ...
          <View className="flex-1 items-center">
            ...
            <Text className="text-gray-500 text-xs mt-0.5">Step 5 of 7</Text>
          </View>
          <View className="w-10" />
        </View>
        ...
        <View className="px-4 pt-3">
          <View className="h-1.5 bg-gray-200 rounded-full overflow-hidden">
            <View className="h-full w-[71.43%] bg-orange-500 rounded-full" />
          </View>
        </View>
        ...
        >
          ...
          >
            <View className="w-20 h-20 bg-purple-100 rounded-full items-center justify-center">
              <Maximize size={40} color="#A855F7" strokeWidth={2} />
            </View>
          </Animated.View>
          ...
          <Animated.View entering={FadeInDown.delay(200)} className="mb-8">
            ...
            <Text className="text-gray-600 text-base text-center">
              Select the plot size you're looking for
            </Text>
          </Animated.View>
                ...
                >
                  <Text
                    className={`text-lg font-semibold text-center ${
                      selectedSize === size.value ? 'text-purple-700' : 'text-gray-900'
                    }`}
                  >
                    {size.label}
                  </Text>
          ...
          {selectedSize === 'custom' && (
            <Animated.View entering={FadeInDown.delay(100)}>
              <TextInput
                className="bg-white rounded-2xl px-6 py-5 text-gray-900 text-lg border-2 border-purple-300"
        ...
        <View className="px-6 pb-8">
          <Pressable
            ...
            className={`rounded-2xl py-5 items-center ${
              isNextEnabled ? 'bg-purple-500' : 'bg-gray-300'
            }`}
            style={{
              shadowColor: isNextEnabled ? '#A855F7' : '#000',
