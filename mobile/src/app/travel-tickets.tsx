      ...
      <SafeAreaView className="flex-1" edges={['top']}>
        ...
        >
          ...
          <Animated.View
            ...
            className="mx-6 mt-4 bg-blue-50 rounded-2xl p-5"
          >
            <View className="flex-row items-start">
              ...
              <View className="flex-1">
                <Text className="text-blue-900 font-semibold text-sm">Coming Soon</Text>
                <Text className="text-blue-700 text-xs mt-1 leading-5">
                  Travel booking integration is in progress. Search and explore available options with live pricing soon.
                </Text>
              </View>
            </View>
          </Animated.View>
