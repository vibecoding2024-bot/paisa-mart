...
import { ArrowLeft, Train, ArrowLeftRight, Calendar, Users } from 'lucide-react-native';
      ...
      <SafeAreaView className="flex-1" edges={['top']}>
          ...
          <View className="px-6 pt-4">
            ...
            <Animated.View entering={FadeInDown.delay(100).springify()}>
              <View className="flex-row items-center">
                ...
                <View>
                  <Text className="text-white text-2xl font-bold">Book Train Tickets</Text>
                  <Text className="text-white/70 text-sm mt-1">Indian Railways</Text>
                </View>
              </View>
            </Animated.View>
          </View>
        ...
        >
          ...
          >
            {/* From Station */}
            <View className="mb-4">
              <Text className="text-gray-700 font-medium text-sm mb-2">From Station</Text>
              <TextInput
            ...
            <View className="mb-4 mt-2">
              <Text className="text-gray-700 font-medium text-sm mb-2">To Station</Text>
              <TextInput
                className="bg-gray-50 rounded-xl px-4 py-3 text-gray-900 border-2 border-gray-200"
            ...
            <View className="bg-orange-50 rounded-xl p-3 mb-4 border border-orange-200">
              <Text className="text-orange-700 text-xs text-center font-medium">
                🚀 Coming Soon - Train ticket booking integration in progress
              </Text>
            </View>
